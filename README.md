...
A console-based C# application where you duel an opponent. I have re-written the game to use methods.

The fight itself is turned-based. When attacking, damage is dealt based on a random number.
